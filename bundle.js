...
/***/ function(module, exports, __webpack_require__) {
	...
	var wordApi = __webpack_require__(27);
	var authUi = __webpack_require__(5);
	var wordUi = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var searchWord = function searchWord(success, failure, word) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hideShow = function hideShow(arr1, arr2) {
	...
	var randWord = ["Phubbing", "Hundo P", "JOMO", "I can't even", "The struggle is real", "Dipset", "Bae", "V", "P"];

	var randomWordFunk = function randomWordFunk(randWord) {
	  var randomIndex = Math.floor(Math.random() * (randWord.length - 1));
	  $('.random-word').text(randWord[randomIndex]);
	};

	//Word UI

	var deleteWord = function deleteWord(success, failure, id) {
	  $.ajax({
	    method: "DELETE",
	...
	var deleteWordSuccess = function deleteWordSuccess() {
	  getWords();
	};

	var editWord = function editWord(success, failure, definition, wordId) {
	  $.ajax({
	    method: 'PATCH',
	...
	var displayDictionary = function displayDictionary(words) {
	  console.log(words);
	  var dictionaryDisplayTemplate = __webpack_require__(6);
	  ...
	  $('.edit-word').on('click', function (event) {
	    ...
	    $('#edit-definition-form').on('submit', function (event) {
	      event.preventDefault();
	      var definition = getFormFields(this);
	...
	var addWord = function addWord(success, failure, definition, word) {
	  $.ajax({
	    method: "POST",
	    url: app.api.api + "users/" + app.currentUser.id + '/words/',
	    dataType: 'json',
	...
	var displaySearch = function displaySearch(defArr) {
	  var searchDisplayTemplate = __webpack_require__(26);
	  ...
	  $('.word-div').on('click', function (event) {
	    ...
	    console.log(definition);
	    var word = $('.search-word-display').text();
	...
	var searchSuccess = function searchSuccess(data) {
	  ...
	  if (returnList.length === 0) {
	    ...
	    for (var _i = 0; _i < 3; _i++) {
	      defArr.push(returnList[_i].definition);
	    }
	  }
	  console.log(defArr);
	...
	var editWordSuccess = function editWordSuccess(data) {
	  getWords();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class=\"panel panel-default\" }>\n    <div class=\"panel-heading\" role=\"tab\" id=\"headingOne\">\n      <h4 class=\"panel-title\">\n        <a role=\"button\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"."
	    ...
	    + alias2(alias1((depth0 != null ? depth0.entry : depth0), depth0))
	    + "\">\n          "
	    + alias2(alias1((depth0 != null ? depth0.entry : depth0), depth0))
	    + "\n        </a>\n      </h4>\n    </div>\n    <div  class=\"panel-collapse collapse "
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" role=\"tabpanel\" aria-labelledby=\"headingOne\">\n      <div class=\"panel-body \" aria-expanded=\"false\" >\n        <p class=\"word-definition\">"
	    + alias2(alias1((depth0 != null ? depth0.definition : depth0), depth0))
	    + "</p>\n        <button class=\"btn btn-info edit-word\" data-id="
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + ">Edit</button><button class=\"btn btn-danger delete-word\" data-id="
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + ">Delete</button>\n      </div>\n    </div>\n  </div>\n";
	  ...
	  return "\n\n<div class=\"panel-group\" id=\"accordion\" role=\"tablist\" aria-multiselectable=\"true\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.words : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	    return "  <div class=\"row\">\n    <div class=\"panel panel-inverse \" >\n      <div class=\"panel-body\">\n\n        <div class=\"col-md-12\">\n          <p class=\"search-word-definition word-div\" }>"
	    + container.escapeExpression(container.lambda(depth0, depth0))
	    + "</p>\n        </div>\n      </div>\n    </div>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.defArr : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
